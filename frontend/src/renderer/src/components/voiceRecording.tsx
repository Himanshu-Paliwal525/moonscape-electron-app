...
const VoiceMessagingBox = ({ voiceMessage, setVoiceMessage, user, receiver }: Props) => {
          ...
          <div className="flex items-center py-1">
            ...
            {recordingStopped ? (
              <button onClick={AnotherRecord}>
                <img
                  src={anotherRecord}
                  alt=""
                  className="h-6 mr-1 hover:shadow-[0_0_1px_gray] rounded-full"
                />
              </button>
            ) : (
              <button onClick={() => stopAudioVisualizer(false)}>
                <img src={stop} alt="" className="h-3 mx-1 mr-4 invert" />
              </button>
            )}
            ...
            {recordingStopped &&
              (playing ? (
                ...
                >
                  <img src={pause} alt="" className="h-4 mx-1 mr-3" />
                </button>
              ) : (
                <button
                  onClick={() => {
                ...
                >
                  <img src={play} alt="" className="h-4 mx-1 mr-3" />
                </button>
              ))}
          </div>
        )}
