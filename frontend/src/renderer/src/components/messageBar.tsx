...
const MessageBar = ({ message, receiver, setMessage, sendMessage }: Props) => {
    ...
    return (
        receiver && (
            <div
                className={`p-[7px] w-full shadow-[0_0_4px_black] flex z-20`}
            >
                <VoiceMessagingBox voiceMessage={voiceMessage} setVoiceMessage={setVoiceMessage} user={message.user} receiver={receiver}/>

                {!voiceMessage && <textarea
